...
Install the Hide Titles plugin via WordPress Dashboard (from plugin directory or from your computer), or upload the files manually to your server and activate the plugin.
...
= How to hide titles from pages and single posts? =

Activate the plugin, go to plugin settings page and choose your option and click on 'Save Changes' button.
